...
$PATH/observing_monitor.py --input_dir $REPO/auxTel/L1Archiver --output $WEBDIR/auxTel --gen 3
$PATH/observing_monitor.py --input_dir $REPO/NCSA_auxTel --output $WEBDIR/NCSA_auxTel
$PATH/observing_monitor.py --input_dir $REPO/BOT --output $WEBDIR/BOT --num_days 3
